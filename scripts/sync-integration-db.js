...
function integrationDefinitions(usersBySlug) {
  ...
  return [
    ...
    { user: user1, name: 'Priority Quote Notification to WhatsApp', description: 'Receive Priority quote webhooks and send WhatsApp template notifications.', slug: 'priority-quote-whatsapp', type: 'webhook', codeFolder: 'src/integrations/user_001/priority-quote-whatsapp' },
