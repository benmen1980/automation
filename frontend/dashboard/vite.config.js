...
// http://localhost:3001) so the dashboard can be run with just
...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '/webhooks': process.env.VITE_PROXY_TARGET || 'http://localhost:3001',
      '/health': process.env.VITE_PROXY_TARGET || 'http://localhost:3001',
    },
  },
});
